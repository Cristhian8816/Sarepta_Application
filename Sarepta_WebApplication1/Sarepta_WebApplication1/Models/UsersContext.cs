...
namespace Sarepta_WebApplication1.Models
{
    public partial class UsersContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //optionsBuilder.UseSqlServer("Data Source=LAPTOP-E3OD0JS8\\SQLEXPRESS;Initial Catalog = Sarepta_Consultory;user id=desenv;password=desenv; MultipleActiveResultSets=true; Persist Security Info=True;");

                //optionsBuilder.UseSqlServer("Data Source = MVMOAN024P\\SQLEXPRESS; Initial Catalog = Sarepta_Consultory; Integrated Security = True");

                optionsBuilder.UseSqlServer("Data Source = SQL5059.site4now.net; Initial Catalog = DB_A5E858_SareptaConsultory; User Id = DB_A5E858_SareptaConsultory_admin; Password = 40A39j21c14a11l");                            
            }
        }
